...
public class ArbolGen {
    ...
    public ListaDinamica ancestros(Object elem) {
        ListaDinamica ancestros = new ListaDinamica();
        ancestrosAux(this.raiz, ancestros, elem);
        return ancestros;
    }

    private boolean ancestrosAux(NodoGen nodo, ListaDinamica ancestros, Object elem) {
    ...
    public ListaDinamica listarPreorden() {
        ListaDinamica preorden = new ListaDinamica();
    ...
    private void preordenAux(NodoGen nodo, ListaDinamica preorden) {
        if (nodo != null) {
    ...
    private void posordenAux(NodoGen nodo, ListaDinamica posorden) {
    ...
    public ListaDinamica listarInorden() {
        ListaDinamica salida = new ListaDinamica();
        listarInordenAux(this.raiz, salida);
        return salida;
    }

    private void listarInordenAux(NodoGen n, ListaDinamica ls) {
    ...
    public ListaDinamica listarPorNiveles() {
        ListaDinamica niveles = new ListaDinamica();
    ...
    private boolean sonFronteraAux(NodoGen nodo, ListaDinamica unaLista) {
    ...
    // Crear public boolean sonFrontera(Lista unaLista) que recibe una lista de
    // elementos almacenada en una estructura del tipo Listay debe verificar si la
    // lista contiene los elementos de la frontera del árbol, sin importar el orden
    ...
    private boolean equalsAux(NodoGen nodoArbolOrig, NodoGen nodoArbolOtro) {
        ...
        } else if (!nodoArbolOrig.equals(nodoArbolOtro)) { // Si alguno es nulo, entonces pregunto si donde estoy son
                                                           // iguales (o sea, ambos nulos)
